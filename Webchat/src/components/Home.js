  ...
  return (
    <div onClick={() => onClick(user)} className="displayName">
      <div className="displayPic">
        <img
          src="https://eatopiaworld.com/wp-content/uploads/2022/04/demo-user-1.jpg"
          alt=""
        />
      </div>
      <div
        ...
        <div className="listOfUsers">
          {user.users.length > 0
            ? user.users
                ...
                .map((user) => {
                  return (
                    <User onClick={startChat} user={user} key={user.uid} />
                  );
                })
            : null}
        </div>
        <div className="chatArea">
          ...
          {chat ? (
            <div className="chatControls">
              ...
              />
              <button className="button-new" onClick={sendMessage}>
                Send
              </button>
            </div>
          ) : null}
